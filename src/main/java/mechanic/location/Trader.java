        ...
        do {
            ...
            tradeMenu.addItem("Покупка", () -> {
                ...
                for (Item item : tradeItems) {
                    buyMenu.addItem(item.getName(), () -> item.use(UseSettings.BUY), MenuItemType.BUY, item);
                }
            ...
            tradeMenu.addItem("Продажа", () -> {
                ...
                for (Item item : Character.getInstance().getInventory().getItems()) {
                    sellMenu.addItem(item.getName(), () -> item.use(UseSettings.SELL), MenuItemType.SELL, item);
                }
