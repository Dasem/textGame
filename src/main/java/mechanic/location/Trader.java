        ...
        do {
            ...
            tradeMenu.addItem("Покупка", () -> {
                ...
                for (Item item : tradeItems) {
                    buyMenu.addItem(item.getName(), () -> item.use(UseSetting.BUY), MenuItemType.BUY, item);
                }
            ...
            tradeMenu.addItem("Продажа", () -> {
                ...
                for (Item item : Character.getInstance().getInventory().getItems()) {
                    sellMenu.addItem(item.getName(), () -> item.use(UseSetting.SELL), MenuItemType.SELL, item);
                }
